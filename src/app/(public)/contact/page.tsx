...
export default function ContactUsPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col overflow-x-hidden bg-rental-blue-900">
      ...
      <section className="w-full pb-6 sm:pb-12 md:pb-5 text-center">
        <div className="px-3 sm:px-6 md:px-10 lg:px-[150px] max-w-[100vw]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-8 lg:gap-26 items-stretch pt-3 sm:pt-7 px-1 sm:px-4 md:px-7">
            {/* Left Column - Contact Us with Horizontal Background (form first on mobile via order) */}
            <div 
              className="relative overflow-hidden rounded-lg w-full order-2 lg:order-1 min-h-[260px] sm:min-h-[320px] md:min-h-[400px]"
              style={{
            ...
            >
              <div className="absolute inset-0 w-full h-full justify-center items-center flex" />
              <div className="relative z-10 pt-5 sm:pt-12 px-3 sm:px-8 md:px-12 pb-3 sm:pb-5 flex flex-col h-full w-full items-center min-h-0">
                <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white font-outfit mb-2 sm:mb-4 text-center">
                  Contact Us
                </h1>
                <p className="text-white font-outfit text-xs sm:text-base md:text-lg leading-relaxed mb-4 sm:mb-8 max-w-md text-center px-1">
                ...
                {/* Contact Person Image - hidden or smaller on very small screens */}
                <div className="mt-auto relative w-full flex justify-center">
                  <img 
                    src={ASSETS.CONTACT_PERSON} 
                    alt="Contact person" 
                    className="w-full max-w-[240px] sm:max-w-md h-auto object-contain mx-auto"
                    style={{ maxHeight: 'clamp(140px, 35vh, 800px)' }}
                  />
                </div>
              </div>
            </div>

            {/* Right Column - Send us a Message Form (shown first on mobile) */}
            <div className="bg-white p-4 sm:p-8 md:p-12 rounded-lg shadow-lg w-full flex flex-col order-1 lg:order-2 min-w-0">
              <h2 className="text-xl sm:text-3xl md:text-4xl font-bold text-blue-900 font-outfit mb-1 sm:mb-2">
                Send us a Message
              </h2>
              <p className="text-gray-600 font-outfit text-xs sm:text-sm mb-3 sm:mb-6">
              ...
              <form className="flex flex-col gap-3 sm:gap-4" onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                  <div className="flex flex-col gap-1.5 sm:gap-2">
                    ...
                    <input
                      ...
                      placeholder="John"
                      required
                      className="min-h-[44px] rounded-lg border-2 border-gray-200 bg-white px-3 sm:px-4 py-2.5 sm:py-3 font-outfit text-sm outline-none transition-all focus:border-blue-600 focus:shadow-[0px_0px_0px_3px_rgba(32,94,215,0.1)] w-full"
                    />
                  </div>
                  <div className="flex flex-col gap-1.5 sm:gap-2">
                ...
                <div className="flex flex-col gap-1.5 sm:gap-2">
                  ...
                  <textarea
                    ...
                    rows={5}
                    required
                    className="min-h-[100px] sm:min-h-[120px] resize-y rounded-lg border-2 border-gray-200 bg-white px-3 sm:px-4 py-2.5 sm:py-3 font-outfit text-sm outline-none transition-all focus:border-blue-600 focus:shadow-[0px_0px_0px_3px_rgba(32,94,215,0.1)] w-full"
                  />
                </div>

                <button 
                  type="submit" 
                  className="mt-2 min-h-[44px] rounded-lg bg-blue-900 px-6 sm:px-8 py-3 font-outfit text-sm sm:text-base font-semibold text-white transition-all hover:bg-blue-800 hover:shadow-lg touch-manipulation"
                >
                  Send Message
                </button>
              </form>
      ...
      <section className="w-full pb-6 sm:pb-12 md:pb-16">
        <div className="px-3 sm:px-6 md:px-10 lg:px-[150px] max-w-[100vw]">
          <div 
            className="relative overflow-hidden rounded-lg w-full min-h-[320px] sm:min-h-[360px] md:min-h-[400px]"
            style={{
          ...
          >
            ...
            <div className="relative z-10 p-4 sm:p-8 md:p-12 w-full min-h-[320px] sm:min-h-[360px] md:min-h-[400px]">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-12">
            {/* Left Side - Contact Information */}
            <div className="min-w-0">
              <h2 className="text-xl sm:text-3xl md:text-4xl font-bold text-white font-outfit mb-2 sm:mb-3">
                Contact Information
              </h2>
              <p className="text-white font-outfit text-sm sm:text-base mb-4 sm:mb-8 opacity-90">
              ...
              <div className="flex flex-col gap-4 sm:gap-6">
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-white font-outfit text-sm sm:text-base mb-1 break-all">
                      Globe: +639178886298
                    </p>
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div className="min-w-0 overflow-hidden">
                    ...
                    <p className="text-white font-outfit text-sm sm:text-base break-all">
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-white font-outfit text-sm sm:text-base mb-1">
            ...
            <div className="min-w-0">
              <h2 className="text-xl sm:text-3xl md:text-4xl font-bold text-white font-outfit mb-4 sm:mb-8">
                Follow us on
              </h2>
              <div className="flex flex-wrap gap-3 sm:gap-6">
                ...
                <a 
                  href="#facebook" 
                  className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-white/10 hover:bg-white/20 active:bg-white/25 transition-all flex items-center justify-center flex-shrink-0 touch-manipulation"
                  aria-label="Facebook"
                >
