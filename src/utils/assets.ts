...
type AssetId =
  ...
  // Backgrounds
  | 'BG_HERO_LANDING' | 'BG_HERO_LANDING_2' | 'BG_HERO_LANDING_NEW' | 'BG_CONTACT_US' | 'BG_TESTIMONIALS' | 'BG_LOGIN' | 'BG_RENT_MANAGERS' | 'BG_BLOG' | 'BG_NEWS' | 'BG_CONTACT_HORIZONTAL' | 'BG_CONTACT_VERTICAL' | 'BG_CREATE_LISTING'
  // Images - Contact
  | 'CONTACT_PERSON'
  // Decorative
