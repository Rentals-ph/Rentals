...
| 'ABOUT_TEAM_LEADER' | 'ABOUT_TEAM_IAN' | 'ABOUT_TEAM_ISAAC' | 'ABOUT_TEAM_NYO'
// Backgrounds
| 'BG_HERO_LANDING' | 'BG_HERO_LANDING_2' | 'BG_HERO_LANDING_NEW' | 'BG_CONTACT_US' | 'BG_TESTIMONIALS' | 'BG_LOGIN' | 'BG_LOGIN_MODAL_LEFT' | 'BG_RENT_MANAGERS' | 'BG_RENT_MANAGERS_HERO' | 'BG_AGENT_DETAILS' | 'BG_RENT_MANAGERS_FOOTER' | 'BG_BLOG' | 'BG_NEWS' | 'BG_CONTACT_HORIZONTAL' | 'BG_CONTACT_VERTICAL' | 'BG_CREATE_LISTING'
  // Images - Contact
  | 'CONTACT_PERSON'
  // Images - Agents
  | 'AGENTS_HERO_PERSON'
...
export const ASSETS = {
  ...
  BG_AGENT_DETAILS: getAsset('BG_AGENT_DETAILS')!,
  ...
  ABOUT_TEAM_LEADER: getAsset('ABOUT_TEAM_LEADER')!,
  ABOUT_TEAM_IAN: getAsset('ABOUT_TEAM_IAN')!,
  ABOUT_TEAM_ISAAC: getAsset('ABOUT_TEAM_ISAAC')!,
  ABOUT_TEAM_NYO: getAsset('ABOUT_TEAM_NYO')!,
  // Placeholders
