...
import type { ListingFormData } from '@/features/listings'
import { DEFAULT_LISTING_FORM_DATA } from '@/features/listings'

// Re-export for backward compatibility
export type { ListingFormData } from '@/features/listings'
