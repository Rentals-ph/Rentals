...
function DigitalProfileCard({ label = 'Scan to view my profile', className = '' }: DigitalProfileCardProps) {
  return (
    <div className={`w-full lg:w-1/3 lg:max-w-sm flex flex-col items-end justify-center ${className}`}>
      ...
      <p className="mt-3 text-xs md:text-sm text-blue-100 text-right">
        {label}
      </p>
    </div>
  )
