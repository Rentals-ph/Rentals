...
use App\Domain\Content\Models\Downloadable;
use App\Http\Requests\Content\CreateDownloadableRequest;
use App\Http\Requests\Content\UpdateDownloadableRequest;
...
class DownloadableController extends Controller
{
     ...
     */
    public function store(CreateDownloadableRequest $request): JsonResponse
    {
        $user = $request->user();
        ...
        // Validation handled by CreateDownloadableRequest
    ...
    public function update(Request $request, int $id): JsonResponse
    {
        ...
        // Validation handled by UpdateDownloadableRequest
