...
use App\Http\Requests\Content\CreatePageBuilderRequest;
use App\Http\Requests\Content\UpdatePageBuilderRequest;
...
class PageBuilderController extends Controller
{
     ...
     */
    public function store(CreatePageBuilderRequest $request): JsonResponse
    {
        try {
            $user = $request->user();
            ...
            // Validation handled by CreatePageBuilderRequest
     ...
     */
    public function update(UpdatePageBuilderRequest $request, $id): JsonResponse
    {
        try {
            $user = $request->user();
            ...
            // Validation handled by UpdatePageBuilderRequest
            $validated = $request->validated();
